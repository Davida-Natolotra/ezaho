...
import { getFacebookLikes } from "../../redux/slices/collecteVIH";
...
export default function GraphFB() {
	...
	const graphLikesNow = useSelector(
		(state) => state.VIHCollecte.likes.val_current
	);
	const graphLikesPrev = useSelector(
		(state) => state.VIHCollecte.likes.val_prev
	);
	...
	return (
		<Card>
			<CardHeader
				title="Nombre nouveau j'aime de la page Facebook Tanora Cool"
				action={
					<>
