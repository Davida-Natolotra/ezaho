...
import { getFacebookReach } from "../../redux/slices/ezaho";
...
export default function GraphFB() {
	...
	const graphReachNow = useSelector((state) => state.ezaho.reach.val_current);
	const graphReachPrev = useSelector((state) => state.ezaho.reach.val_prev);
	...
	return (
		<Card>
			<CardHeader
				title="Couverture de la page Facebook E-zaho"
				action={
					<>
