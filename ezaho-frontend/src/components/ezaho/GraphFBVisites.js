...
import { getFacebookVisites } from "../../redux/slices/ezaho";
...
export default function GraphFB() {
	...
	const graphVisitesNow = useSelector(
		(state) => state.ezaho.visites.val_current
	);
	const graphVisitesPrev = useSelector((state) => state.ezaho.visites.val_prev);
	...
	return (
		<Card>
			<CardHeader
				title="Nombre de visite de la page Facebook E-zaho"
				action={
					<>
